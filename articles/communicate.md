...
once), then use
[`lifecycle::badge()`](https://lifecycle.r-lib.org/reference/badge.md)
to insert a badge:
...
[`lifecycle::deprecated()`](https://lifecycle.r-lib.org/reference/deprecated.md)
to make the deprecation status more obvious from the outside, and use
[`lifecycle::is_present()`](https://lifecycle.r-lib.org/reference/deprecated.md)

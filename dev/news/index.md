...
- [`signal_stage()`](https://lifecycle.r-lib.org/dev/reference/signal_stage.md)
...
- Improvements to
  [`lint_lifecycle()`](https://lifecycle.r-lib.org/dev/reference/lifecycle_linter.md)
  and
  [`lint_tidyverse_lifecycle()`](https://lifecycle.r-lib.org/dev/reference/lifecycle_linter.md)
  ...
  - Exported
    [`lifecycle_linter()`](https://lifecycle.r-lib.org/dev/reference/lifecycle_linter.md)
...
- `last_warnings()` has been renamed to
  [`last_lifecycle_warnings()`](https://lifecycle.r-lib.org/dev/reference/last_lifecycle_warnings.md)
...
- Added experimental
  [`signal_experimental()`](https://lifecycle.r-lib.org/dev/reference/deprecated-signallers.md)
  and
  [`signal_superseded()`](https://lifecycle.r-lib.org/dev/reference/deprecated-signallers.md)
  functions.
...
- New
  [`expect_deprecated()`](https://lifecycle.r-lib.org/dev/reference/expect_deprecated.md)
  and
  [`expect_defunct()`](https://lifecycle.r-lib.org/dev/reference/expect_deprecated.md)
...
- New
  [`is_present()`](https://lifecycle.r-lib.org/dev/reference/deprecated.md)
  function to test whether the caller has supplied a
  [`deprecated()`](https://lifecycle.r-lib.org/dev/reference/deprecated.md)
  function.

...
user. Control with
[`options(lifecycle_verbosity)`](https://lifecycle.r-lib.org/dev/reference/verbosity.md).
...
[`lifecycle()`](https://lifecycle.r-lib.org/dev/reference/lifecycle-package.md)

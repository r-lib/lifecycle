...
We don't currently provide automated signals for experimental functions because it's not clear how they would work, or if the effort to use them consistently would be worth the payoff.
See discussion in <https://github.com/r-lib/lifecycle/issues/44>.

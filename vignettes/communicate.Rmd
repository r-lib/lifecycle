...
Note that your `what` fragment needs to make sense with "was deprecated ..." added to the end, and you `with` fragment needs to make sense in the sentence "Please use `{with}` instead".

...
-   `deprecate_soft()` is used before `deprecate_warn()`.
    ...
    There is no warning when the deprecated feature is called indirectly by another package --- the goal is to ensure to warn only the person who has the power to stop using the deprecated feature.

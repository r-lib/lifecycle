...
Test whether your package depends on deprecated features directly or indirectly by inserting `withr::local_options()` in the `tests/testthat.R` file just before `test_check()` is called:
